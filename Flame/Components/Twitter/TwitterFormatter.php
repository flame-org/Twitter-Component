...
class TwitterFormatter extends \Nette\Object
{
	...
	public function tweetFormat(\stdClass $tweet){
	...
	public function userLink($user, $status = null){
		return new Url("http://twitter.com/$user" . ($status !== null ? "/statuses/$status" : ''));
	}


	public function intentUrlFormat($status, $action){
